const fr = {
  ...
  common: {
    ...
    no_budget_text1: "Retournez à la page principale et ajoutez un budget à votre projet.",
    no_budget_text2: "Retournez à la page précédente et ajoutez un budget à votre composante.",
