const en = {
  ...
  common: {
    ...
    no_budget_text1: "Go back to the main page and add a budget for your project.",
    no_budget_text2: "Go back to the previous page and add a budget for your subproject.",
