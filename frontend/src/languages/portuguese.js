const pt = {
  ...
  common: {
    ...
    no_budget_text1: "Volte para a página principal e adicione um orçamento para o seu projeto.",
    no_budget_text2: "Voltar à página anterior e adicionar um orçamento para o seu subprojeto.",
